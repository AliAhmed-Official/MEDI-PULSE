...
function FinanceDashboardMedicationInvoices() {
  const tableheaders = ['Invoice Number', 'MR Number', 'Patient Name', 'Patient Contact', 'Doctor Name', 'Pharmacist ID', 'Pharmacist Name', 'Prescription Date', 'Total Amount', 'Payment Method', 'Payment Status'];
  return (
    <>
      ...
      <main className='bg-[#F0F3FB] mt-[60px] z-0 lg:ml-[260px] h-screen'>
        <div className='m-5 flex items-center gap-3 text-gray-500'>
          ...
          <p className='text-xl md:text-2xl font-semibold'>Medication Invoices</p>
            ...
            <table className="min-w-full bg-white border border-gray-300 rounded-lg shadow-md">
              ...
              <tbody className="text-gray-700">
                <tr className="hover:bg-gray-100 cursor-pointer">
                  ...
                  <td className="py-2 px-4 border-b">Aqsa Shahid</td>
...
export default FinanceDashboardMedicationInvoices;